...
(function(a) {
    ...
    a.extend(d.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-material", sFilterInput: "form-control input-sm", sLengthSelect: "form-control input-sm", sProcessing: "dataTables_processing panel panel-default" });
    d.ext.renderer.pageButton.material = function(b, l, w, x, m, r) {
        ...
        try { var v = a(l).find(c.activeElement).data("dt-idx") } catch (z) {}
